 ...
 */
export function getProductListCurrentPage( state, siteId ) {
 ...
 * @param {Object} state Global state tree
 * @param {Number} [siteId] Site ID to check. If not provided, the Site ID selected in the UI will be used
 * @return {array|false} Array of products or false if there was an error.
 */
export function getProductListProducts( state, siteId ) {
 ...
 */
export function getProductListRequestedPage( state, siteId ) {
